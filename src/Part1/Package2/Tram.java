...
public class Tram extends Metro {
    ...
    public String toString() {
        if(getNumVehicles() == 0){
            return "\nSince no tram has been selected, the number of wheels, the maximum speed, and the number of venhicles are \nset to 0. Travelling does not occur. There are 0 stops and no creation year.";
        }
